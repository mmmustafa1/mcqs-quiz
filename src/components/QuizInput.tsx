...
const QuizInput = () => {
  ...
  return (
    <div className="space-y-8 animate-fade-in">
      <h2 className="text-2xl font-semibold text-center text-foreground">Load Your Quiz</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-start">
        ...
        <div>
          ...
          <Button
            ...
            variant="outline"
          >
            <Upload className="mr-2 h-4 w-4" /> Upload Text File (.txt)
          </Button>
          ...
          <div className="relative">
            <Textarea
              ...
              className="min-h-[250px] text-sm focus-visible:ring-primary focus-visible:ring-offset-1"
            />
          </div>
        </div>
        ...
        <Alert className="bg-muted/50 dark:bg-muted/20 border-border">
          ...
          <AlertTitle className="font-semibold">Expected Format</AlertTitle>
          <AlertDescription className="mt-2 space-y-2">
            <p className="text-xs text-muted-foreground">
              Questions start with "Q:" or numbers (1., 2.). Mark the correct answer with an asterisk (*). Explanations are optional.
            </p>
            <pre className="text-xs whitespace-pre-wrap overflow-auto max-h-[200px] p-3 bg-background dark:bg-muted/30 rounded-md border border-border scrollbar-thin scrollbar-webkit">
